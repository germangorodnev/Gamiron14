...
var dp = dot_product(phy_speed_x, phy_speed_y, forwX, forwY);
var forwVelX = forwX * dp,
    forwVelY = forwY * dp;
dp = dot_product(phy_speed_x, phy_speed_y, rightX, rightY);
var rightVelX = rightX * dp,
    rightVelY = rightY * dp;
var arr;
phy_speed_x = forwVelX + rightVelX;
phy_speed_y = forwVelY + rightVelY;
//return arr;
...
var dot = dot_product(xright, yright, phy_speed_x, phy_speed_y);
